...
if (isset($_POST['search']) ) {
 ...
 $sql2 = "SELECT id FROM cat WHERE cat_name = '$search'  ";
...
$sql = "INSERT INTO movie_cat (movie_id, cat_id)
VALUES ('$movieid', '$id')";
...
if (mysqli_query($conn, $sql)) {
	...
	?>
            <script>
                window.location.replace("../addcat.php?action=<?php echo $movieid ?>&Failed");
            </script>
            <?php
}
 ...
 $sql3 = "SELECT id FROM cat WHERE cat_name = '$search2'  ";
...
$sql4 = "INSERT INTO movie_cat (movie_id, cat_id)
VALUES ('$movieid', '$id2')";
...
if (mysqli_query($conn, $sql4)) {
 ...
 $sql5 = "SELECT id FROM cat WHERE cat_name = '$search3'  ";
...
$sql6 = "INSERT INTO movie_cat (movie_id, cat_id)
VALUES ('$movieid', '$id3')";
...
if (mysqli_query($conn, $sql6)) {
 ...
 $sql7 = "SELECT id FROM cat WHERE cat_name = '$search4'  ";
...
$sql8 = "INSERT INTO movie_cat (movie_id, cat_id)
VALUES ('$movieid', '$id4')";
...
if (mysqli_query($conn, $sql8)) {
 ...
 $sql9 = "SELECT id FROM cat WHERE cat_name = '$search5'  ";
...
$sql10 = "INSERT INTO movie_cat (movie_id, cat_id)
VALUES ('$movieid', '$id5')";
...
?>
            ...
            <script>
                window.location.replace("../addactor.php?action=<?php echo $movieid ?>");
            </script>
            <?php
}
}else{
