...
//Search query.
   ...
   while ($Result2 = MySQLi_fetch_array($ExecQuery2)) {
       ...
       <div class="dropdown-item search-iteam" style="cursor: pointer;" onclick='fill3("<?php echo $Result2['actor_name']; ?>")' >
  ...
  <?php
    ...
    <div class="dropdown-item " style="text-align: center;background-color: rgba(0,0,0,0.6);border:transparent;font-size: 20px;cursor: pointer;" onclick="document.getElementById('addnewactor').style.display='block';document.getElementById('display3').style.display='none'"><strong>Add New Actor</strong></div>
<?php
} 
?>
